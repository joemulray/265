...
"""You will write a Python program that attempts to solve the Knight's Tour 
for a given board by brute-force methods. The Knight's Tour 
is an attempt to move the knight on a board, such that each space is visited exactly once."""
